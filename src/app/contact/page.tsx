          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 rounded-lg p-8 border border-blue-200">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="mt-6">
                  If you have any questions about features, pricing, or anything else, please feel
            ...
            <div className="bg-green-50 rounded-lg p-8 border border-green-200">
              ...
              <p className="text-gray-700">
                We aim to respond to all messages within <strong>24 hours</strong> or less. If you
                don't receive a response, please check your spam folder.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer:
                  "You can sign up for free on our homepage. No credit card required and you get a 14-day free trial with all features included.",
              },
              {
                question: "Can I cancel anytime?",
                answer:
                  "Yes, you can cancel at any time without giving a reason. We have no long-term contracts or commitments.",
              },
              {
                question: "Do you support integrations?",
                answer:
                  "Yes, we support integrations with over 100 popular applications. Contact us for more details.",
              },
              {
                question: "Is my data safe?",
                answer:
                  "Yes, we use end-to-end encryption and comply with international security standards. All data is backed up daily.",
              },
            ].map((faq, index) => (
              <details
                key={index}
